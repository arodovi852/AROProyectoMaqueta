...
/**
 * Series Service - Provides CRUD operations for TV series
 * 
 * Supports both mock mode (for development) and TMDB API integration.
 * When api.mock-mode=true, uses in-memory mock data.
 */
@Service
