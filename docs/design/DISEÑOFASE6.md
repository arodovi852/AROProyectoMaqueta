...
Variables requeridas: - Colores de fondo - Colores de texto - Colores de borde - Colores de sombra - Estados (hover, active)
2. Theme Switcher

Crea un componente theme-switcher que: - Muestre toggle visual - Cambie atributo data-theme en elemento <html> - Guarde preferencia en localStorage - Cargue preferencia al iniciar - Se coloque en header, visible
